...
public class TennisHands : MonoBehaviourPunCallbacks
{
    ...
    void Update()
    {
       ...
       else if (!TTBat2.hasSelected && !leftParent.transform.GetChild(0).gameObject.activeSelf &&
       ...
       else if (!TTBat1.hasSelected && !leftParent.transform.GetChild(0).gameObject.activeSelf &&
